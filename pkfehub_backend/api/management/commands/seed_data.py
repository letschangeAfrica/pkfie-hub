...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS(f"  ✓ {len(created_announcements)} announcements created."))
        ...
        if not options["no_notify"]:
            ...
            for user in users:
                ...
                notifs_created += 1
            self.stdout.write(self.style.SUCCESS(f"  ✓ {notifs_created} notifications created."))
